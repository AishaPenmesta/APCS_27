...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        int rizzPower = (int)(Math.random()*(30-10)+10);
        int sigmaSpeed= (int)(Math.random()*(30-10)+10);
        int brainrotEnergy = (int)(Math.random()*(25-5)+5) + trainingBonus/2;
        ...
        int movePower = (int)(Math.random()*(20-5)+5);
        ...
        int rivalHealth = (int)(Math.random()*(150-80)+80);
        int rivalPower = (int)(Math.random()*(35-15)+15);
        int rivalDefense = (int)(Math.random()*(20-5)+5);
        ...
        double fateRoll = Math.random()*(2.0-0.5)+0.5;
        ...
        //     to (int).
        double rivalFuryRoll = Math.random()*(1.5-1.0)+1.0;
        ...
        int basePoints = (int)(Math.random()*(300-50)+50);
